class OpenSearchComplexityAnalyzer {
    ...
    analyzeObject(obj, path = '', depth = 0) {
        const analysis = {
            complexityScore: 0,
    ...
    traverseObject(obj, analysis, path, depth) {
    ...
    analyzeArray(arr, analysis, path, depth) {
        analysis.fieldCount++;
        if (arr.length === 0) {
            return;
        }
    ...
    analyzeObjectProperties(obj, analysis, path, depth) {
    ...
    analyzePrimitiveValue(value, analysis, path) {
        analysis.fieldCount++;
    ...
    analyzeStringValue(value, analysis, path) {
    ...
    calculateComplexityScore(analysis) {
        ...
        const rawScore = breakdown.structuralComplexity +
    ...
    estimateIndexSize(analysis, originalData) {
